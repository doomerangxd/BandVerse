...
const contenedor = document.querySelector('#dinamicDos');
const btnAgregar = document.querySelector('#agregarDos');
...
btnAgregar.addEventListener('click', e => {
    ...
    div.innerHTML = `<label>${total++}</label> - <input type="file" name="fotos[]" placeholder="Rol - Nombre y apellidos" required class="step__input"><button onclick="eliminar(this)">Eliminar</button>`;
