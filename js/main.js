...
btnAgregar.addEventListener('click', e => {
    ...
    div.innerHTML = `<label>${total++}</label> - <input type="text" name="nombre[]" placeholder="Rol - Nombre y apellidos" class="step__input" required><button onclick="eliminar(this)">Eliminar</button>`;
